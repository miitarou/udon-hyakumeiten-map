...
- **都道府県フィルタ** — 全国から絞り込み
- **特徴で探す** — 「お酒と楽しむ」「香りを楽しむ」「コシ強め」など、AI推定タグと外部シグナル由来タグを使った探索補助フィルタ
- **選出年フィルタ** — カテゴリに応じて利用可能年度を動的生成し、コンパクトなプルダウンで選択
  - うどん：2017 / 2018 / 2019 / 2020 / 2022 / 2024
  - そば：2017 / 2018 / 2019 / 2021 / 2022 / 2024 / 2025
- **選出回数フィルタ** — 最新年度で初登場 / 1回のみ / 2回以上〜4回以上 / 殿堂入り（カテゴリ上位10%）をプルダウンで絞り込み
