...
TERM_RULES: dict[str, tuple[tuple[str, float, float], ...]] = {
    ...
    "手挽き": (("style.stone_milled", 0.82, 0.84), ("texture.aroma_focused", 0.74, 0.8)),
    "手打ち": (("style.handmade", 0.84, 0.88),),
    "手打": (("style.handmade", 0.84, 0.88),),
    "本格手打": (("style.handmade", 0.88, 0.88),),
    "本手打": (("style.handmade", 0.86, 0.88),),
    "手造り": (("style.handmade", 0.82, 0.84),),
    "純手打": (("style.handmade", 0.9, 0.9),),
    "自家製麺": (("style.handmade", 0.76, 0.82),),
    ...
    "一般店": (("scene.calm_meal", 0.48, 0.56),),
    "おでん": (("scene.calm_meal", 0.5, 0.56),),
    "讃岐": (("style.sanuki_influenced", 0.9, 0.9), ("texture.koshi_strong", 0.78, 0.82), ("style.regional_specialty", 0.68, 0.72)),
    "いりこ": (("style.sanuki_influenced", 0.66, 0.72), ("style.regional_specialty", 0.58, 0.64)),
    "無化調": (("mood.traditional", 0.44, 0.52),),
    "コシ": (("texture.koshi_strong", 0.76, 0.78),),
    "喉越し": (("texture.throat_smooth", 0.76, 0.78),),
    ...
    "ひやあつ": (("style.regional_specialty", 0.68, 0.74), ("style.sanuki_influenced", 0.6, 0.68)),
    ...
    "もつ煮込みうどん": (("dish.meat_soup", 0.82, 0.84), ("style.regional_specialty", 0.72, 0.76)),
    "肉うどん": (("dish.meat_soup", 0.78, 0.82),),
    "味噌煮込み": (("dish.miso_nikomi", 0.86, 0.88), ("style.regional_specialty", 0.68, 0.74)),
    "八丁味噌": (("dish.miso_nikomi", 0.78, 0.82), ("style.regional_specialty", 0.74, 0.8)),
    ...
    "とり天": (("dish.tempura", 0.82, 0.84),),
    "舞茸天": (("dish.tempura", 0.8, 0.82),),
    "半熟卵天": (("dish.tempura", 0.8, 0.84),),
    "関西だし": (("style.kansai_dashi", 0.78, 0.82),),
    "京うどん": (("style.kansai_dashi", 0.78, 0.82), ("style.regional_specialty", 0.68, 0.74)),
    "京都素材": (("style.kansai_dashi", 0.58, 0.64), ("style.regional_specialty", 0.56, 0.62)),
    "博多うどん": (("style.hakata_udon", 0.86, 0.88), ("style.regional_specialty", 0.7, 0.76)),
    "うどん居酒屋": (("scene.drink_pairing", 0.76, 0.8), ("scene.calm_meal", 0.56, 0.64)),
    "唎酒師": (("scene.drink_pairing", 0.72, 0.78),),
    "鉄板焼き": (("scene.drink_pairing", 0.54, 0.6), ("mood.modern", 0.5, 0.56)),
    "黒毛和牛": (("dish.meat_soup", 0.74, 0.76), ("mood.modern", 0.5, 0.58)),
    "剛麺": (("texture.koshi_strong", 0.84, 0.84),),
    "鶏卵カレー": (("dish.curry", 0.82, 0.84), ("mood.modern", 0.54, 0.58)),
    ...
    "酒肴": (("scene.drink_pairing", 0.78, 0.82), ("scene.calm_meal", 0.6, 0.68)),
    ...
    "町家": (("mood.traditional", 0.68, 0.74), ("scene.calm_meal", 0.6, 0.68)),
    "隠れ家": (("scene.calm_meal", 0.68, 0.74), ("scene.destination", 0.54, 0.62)),
    "カフェ": (("mood.modern", 0.62, 0.68), ("scene.calm_meal", 0.48, 0.56)),
    "完全予約制": (("scene.destination", 0.62, 0.68), ("scene.calm_meal", 0.58, 0.64)),
    "伝統": (("mood.traditional", 0.72, 0.78),),
    "宮武ファミリー": (("style.sanuki_influenced", 0.7, 0.76), ("mood.traditional", 0.58, 0.64)),
    "薪": (("mood.traditional", 0.52, 0.58), ("style.regional_specialty", 0.48, 0.56)),
    "翁": (("lineage.okina", 0.82, 0.84), ("style.handmade", 0.66, 0.72)),
    "藪": (("lineage.yabu", 0.8, 0.84), ("style.edomae_soba", 0.72, 0.78)),
    "竹やぶ": (("lineage.yabu", 0.82, 0.84), ("style.edomae_soba", 0.66, 0.72)),
    ...
    "ぼっち盛り": (("style.shinshu_soba", 0.78, 0.82), ("style.regional_specialty", 0.7, 0.76)),
    "江戸辛汁": (("style.edomae_soba", 0.76, 0.8),),
    "鴨汁": (("dish.meat_soup", 0.76, 0.8),),
    "十割": (("dish.juwari", 0.86, 0.88), ("texture.aroma_focused", 0.68, 0.74)),
    "生粉打ち": (("dish.juwari", 0.86, 0.88), ("style.handmade", 0.76, 0.8), ("texture.aroma_focused", 0.7, 0.76)),
